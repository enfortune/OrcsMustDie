#include "stdafx.h"
#include "cAllocateHierarchy_HARDWARE.h"


cAllocateHierarchy_HARDWARE::cAllocateHierarchy_HARDWARE()
{
}
...
STDMETHODIMP cAllocateHierarchy_HARDWARE::CreateFrame(LPCSTR Name, LPD3DXFRAME * ppNewFrame)
{
...
STDMETHODIMP cAllocateHierarchy_HARDWARE::CreateMeshContainer(
...
STDMETHODIMP cAllocateHierarchy_HARDWARE::DestroyFrame(LPD3DXFRAME pFrameToFree)
{
...
STDMETHODIMP cAllocateHierarchy_HARDWARE::DestroyMeshContainer(LPD3DXMESHCONTAINER pMeshContainerToFree)
{
